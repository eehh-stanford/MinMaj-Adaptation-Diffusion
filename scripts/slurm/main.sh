...
sbatch --array=1-10 scripts/slurm/run_helper.sh $1 0.05 1.2 1 1000 0.0
sbatch --array=1-10 scripts/slurm/run_helper.sh $1 0.05 1.2 2 1000 0.0
sbatch --array=1-10 scripts/slurm/run_helper.sh $1 0.05 1.2 Both 1000 0.0
